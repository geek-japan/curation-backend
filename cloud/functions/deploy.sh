...
gcloud functions deploy fetch_articles --trigger-event google.pubsub.topic.publish --trigger-resource fetch-article-pubsub --runtime=python39 --region asia-northeast1 --memory 512MB